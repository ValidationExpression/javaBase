...
import com.hhxy.game.GameJFrame;
import javax.swing.*;
import java.awt.*;
...
public class Poker extends JLabel implements MouseListener {
	...
	public void turnFront() {
		this.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\poker" + name + ".png"));
		this.up = true;
	}

	//显示背面
	public void turnRear() {
		this.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\poker\\rear.png"));
		this.up = false;
	}
