...
import com.hhxy.domain.User;
import com.hhxy.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("day23_douDiZhu\\src\\com\\image\\login\\background.png"));
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("day23_douDiZhu\\src\\com\\image\\login\\注册按下.png"));
        }
    }
